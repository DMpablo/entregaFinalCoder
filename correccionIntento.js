class Producto {
            ...
            <div class="col-lg-4 col-md-4 mb-4 p-3">
                <div class="card-100">
                    ...
                    <div class="card-body row">
                        ...
                        <button onclick="agregar(${baseDeDatos})" href="#" class="btn btn-danger">$${baseDeDatos[i].precio}</button>
                    </div>
                </div>
             </div>
    ...
    function agregar(baseDeDatos){

            totalCarrito.push(baseDeDatos[i].precio); 
            mostrarCarrito +=`
            <div class="card" style="width: 18rem;">
            <div class="card-body">
            <p class="card-text">${baseDeDatos[i].nombre}</p>
